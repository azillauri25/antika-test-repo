...
<head>
    <title>Antika Anggrek | Detail Produk - Admin</title>
    <meta charset="utf-8">
...
<div class="content">
    ...
    <div class="container cont-profile text-left" style="margin-bottom:-150px;">
        <?php if ($produk): ?>
            <div class="row">
            <div class="col-md-6">
        ...
        <div id="ubah-produk" style="display: <?php echo $isPerubahanAda ? 'block' : 'none'; ?>;">

...
<head>
    <title>Antika Anggrek | Detail Pesanan - Admin</title>
    <meta charset="utf-8">
...
<div class="content">
        ...
        <tbody>
            <?php if (!empty($orderData['produk'])): ?>
                <?php foreach ($orderData['produk'] as $produk): ?>
                    <tr>
                    <td><img src="<?php echo htmlspecialchars($produk['gambar_produk']); ?>" alt="<?php echo htmlspecialchars($produk['nama_produk']); ?>" style="width:50px; height:auto;"></td>    
    ...
    <?php if (!empty($orderData['bukti_bayar'])): ?>
        <img src="../customer/<?php echo htmlspecialchars($orderData['bukti_bayar']); ?>" alt="Bukti Pembayaran" style="max-width: 400px; max-height: 400px;">
    <?php else: ?>

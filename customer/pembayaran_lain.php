...
$biaya_kirim_value = isset($_POST['biaya_kirim_value']) ? $_POST['biaya_kirim_value'] : 0;
$biaya_kirim_value = str_replace('.', '', $biaya_kirim_value);

// Pastikan itu jadi angka
$biaya_kirim_value = (float)$biaya_kirim_value;
...
$total_akhir = $total_setelah_diskon + $biaya_kirim_value;
...
<div class="container cont-keranjang">
    ...
    <div class="row">
        ...
        <h4 style="padding-bottom: 10px; font-weight:bolder; margin-bottom:20px; border-bottom:2px solid #30364d;">Informasi Penerima</h4>
            ...
            <form action="konfirmasi_pembayaran_lain.php" method="post" enctype="multipart/form-data" style="font-size:12px">
...
<!-- <tr>
    ...
    <td class="text-right">Rp <?php echo number_format($biaya_kirim_value); ?></td>
</tr> -->
<!-- start footer -->
